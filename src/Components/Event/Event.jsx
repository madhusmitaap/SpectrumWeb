...
const EventData = [
    {
        ...
        img: Image1 ,
        title: "EVENT 1",
        title1: " Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, ut!",
    },
    {
        id:2,
        img: Image1 ,
          ...
          {EventData.map((data) => (
                <div key={data.id}>
                    ...
                    sm:order-1 relative z-10">
                        <h1 className="text-5xl sm:text-5xl lg:text-6xl font-bold">{data.title}</h1>
                        <h1 className="text-2xl sm:text-2xl lg:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r
               from-primary to-secondary">{data.title1}
                        </h1>
                    </div>
                    {/*image content*/}
